            ...
            <Fragment>
                ...
                <BrowserRouter>
                    <Switch>
                        ...
                        <Route exact path="/privacy-policy" render={(props) => <PrivacyPage {...props} key={Date.now()} />} />
                        <Route exact path="/refund-policy" render={(props) => <RefundPage {...props} key={Date.now()} />} />
                        <Route exact path="/about-us" render={(props) => <AboutPage {...props} key={Date.now()} />} />

                        <Route exact path="/product-detail/:id" render={(props) => <ProductDetailPage user={this.state.user} {...props} key={Date.now()} />} />
                        ...
                        <Route exact path="/product-list-category/:catg" render={(props) => <ProductCategoryPage {...props} key={Date.now()} />} />
                        <Route exact path="/product-subcategory/:category/:subcategory" render={(props) => <ProductSubCategoryPage {...props} key={Date.now()} />} />

                        <Route exact path="/productbysearch/:key" render={(props) => <SearchPage {...props} key={Date.now()} />} />
