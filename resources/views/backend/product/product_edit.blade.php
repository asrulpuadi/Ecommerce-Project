                                ...
                                <div class="col-lg-8">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="showImage" src="{{ asset($detail->image_one) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="showImage" src="{{ asset($detail->image_two) }}"
                                                style="width: 100px;height: 100px;">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="showImage" src="{{ asset($detail->image_three) }}"
                                                style="width: 100px;height: 100px;">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="showImage" src="{{ asset($detail->image_four) }}"
                                                style="width: 100px;height: 100px;">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="inputProductDescription" class="form-label">Short
                                                Description</label>
                                            <textarea class="form-control" name="short_description" rows="2" placeholder="Enter Short Description">{{ $detail->short_description }}</textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label for="inputProductDescription" class="form-label">Long Description</label>
                                            <textarea id="mytextarea" name="long_description" placeholder="Enter Long Description">
                                        ...
                                        <div class="row g-3">
                                                ...
                                                <select class="form-select" name="subcategory">
                                                    ...
                                                    @foreach ($subcategory as $item)
                                                        <option value="{{ $item->sub_category_name }}"
                                                            {{ $product->subcategory == $item->sub_category_name ? 'selected' : '' }}>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="size" class="form-control"
                                                    value="{{ $detail->size }}" data-role="tagsinput"
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="color" class="form-control"
                                                    value="{{ $detail->color }}" data-role="tagsinput"
